...
public class gen3 {
    public static void main(String[] args){
...

        {
            ...
            mv.visitInsn(Opcodes.DDIV);// dividing the 2 doubles 
            mv.visitVarInsn(Opcodes.DSTORE,5);//storing the quotient of our division
            ...
            mv.visitInsn(Opcodes.IDIV);//dividing our 2 integers
            mv.visitVarInsn(Opcodes.ISTORE,5);//storing our quotient
            mv.visitFieldInsn(Opcodes.GETSTATIC, "java/lang/System", "out", "Ljava/io/PrintStream;");//creating our print stream object
            mv.visitVarInsn(Opcodes.ILOAD, 5);//loading our quotient stored at index 5
            mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "java/io/PrintStream", "println", "(I)V", false);//prints our quotient
            ...
            mv.visitInsn(Opcodes.FDIV);//divides our 2 float numbers
            mv.visitVarInsn(Opcodes.FSTORE,5);//storing the quotient of our division
            ...
            mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "java/io/PrintStream", "println", "(F)V", false);//prints our quotient
            ...
            mv.visitInsn(Opcodes.LDIV);// dividing our 2 longs
            mv.visitVarInsn(Opcodes.LSTORE,5);//storing our quotient
            mv.visitFieldInsn(Opcodes.GETSTATIC, "java/lang/System", "out", "Ljava/io/PrintStream;");//creates our print stream object
            mv.visitVarInsn(Opcodes.LLOAD, 5);// loads our quotient stored in index 5
            mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "java/io/PrintStream", "println", "(J)V", false);//prints our quotient
